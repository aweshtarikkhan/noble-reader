  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="sticky top-0 z-20 bg-background px-4 pt-3 pb-2">
        ...
        <div className="bg-card rounded-xl border border-border p-2 animate-fade-in">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <button onClick={togglePlay} className="w-10 h-10 rounded-full bg-primary flex items-center justify-center transition-smooth active:scale-95" disabled={isLoading}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <p className="font-arabic text-sm text-primary truncate">{surah.name}</p>
                <p className="text-xs text-foreground truncate">{surah.englishName}</p>
              </div>
              ...
              <div className="flex justify-between"><span className="text-[9px] text-muted-foreground">{formatTime(currentTime)}</span><span className="text-[9px] text-muted-foreground">{formatTime(duration)}</span></div>
            </div>
          </div>
        </div>
      </div>
