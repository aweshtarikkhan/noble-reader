  ...
  return (
    <div className="px-4 py-4">
      <input
        ...
        className="w-full px-4 py-3 rounded-xl bg-card border border-gold/10 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-gold/40 transition-smooth mb-4 text-sm"
      />
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                ...
                <span className="font-arabic text-gold text-base">{s.name}</span>
              </div>
              <div className="flex items-center justify-between mt-0.5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-[10px] px-1.5 py-0.5 rounded-full ${s.type === "Meccan" ? "bg-primary/20 text-gold" : "bg-secondary/20 text-secondary"}`}>
                    {s.type}
                  </span>
                </div>
              </div>
