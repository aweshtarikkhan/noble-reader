    ...
    <div className="px-4 py-6 flex flex-col items-center min-h-[70vh]">
      ...
      {locationError ? (
        ...
        <>
          ...
          <div className="mt-3 flex items-start gap-2 px-4 py-3 rounded-xl bg-amber-500/10 border border-amber-500/20 max-w-xs animate-fade-in">
            <AlertCircle className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
            <p className="text-[11px] text-amber-500/90 leading-relaxed text-left">
              Results may vary based on device position. For best accuracy, hold your phone flat on a level surface.
            </p>
          </div>
        </>
      )}
