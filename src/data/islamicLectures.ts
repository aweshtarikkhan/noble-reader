...
export const LECTURE_SERIES: LectureSeries[] = [
  ...
  {
    id: "menk-prophets",
    title: "Stories of the Prophets - Mufti Ismail Menk",
    titleUr: "انبیاء کے قصص - مفتی اسماعیل مینک",
    speaker: "Mufti Ismail Menk",
    speakerUr: "مفتی اسماعیل مینک",
    icon: "📗",
    description: "Complete English lecture series on the Stories of the Prophets - 29 lectures from Adam (AS) to Isa (AS)",
    descriptionUr: "انبیاء کے قصص مکمل انگریزی لیکچر سیریز - 29 لیکچرز حضرت آدم سے حضرت عیسیٰ علیہم السلام تک",
    lectures: MENK_PROPHETS_LECTURES,
  },
  {
    id: "sahaba-stories",
    title: "Stories of the Sahaba & Companions",
    titleUr: "صحابہ کرام کے واقعات",
    speaker: "Various Scholars",
    speakerUr: "مختلف علماء",
    icon: "⚔️",
    description: "19 inspiring short stories of the Sahaba - companions of Prophet Muhammad ﷺ",
    descriptionUr: "صحابہ کرام کے 19 ایمان افروز مختصر واقعات - نبی کریم ﷺ کے ساتھی",
    lectures: SAHABA_STORIES_LECTURES,
  },
  {
    id: "daily-naseehah",
